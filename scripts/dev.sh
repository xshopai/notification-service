...
# Notification Service - Run with direct RabbitMQ (local development)

echo "Starting Notification Service (Direct RabbitMQ)..."
echo "Service will be available at: http://localhost:8011"
echo ""

# Kill any process using port 8011 (prevents "address already in use" errors)
PORT=8011
